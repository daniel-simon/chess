class Game < ApplicationRecord
  ...
  belongs_to :active_player, class_name: "User", foreign_key: "active_player_id", optional: true
  belongs_to :inactive_player, class_name: "User", foreign_key: "inactive_player_id", optional: true
