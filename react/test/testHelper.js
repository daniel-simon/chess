...
requireAll(require.context('../src/components/', true, /^((?!main).)*\.jsx?$/));
requireAll(require.context('../src/containers/', true, /^((?!main).)*\.jsx?$/));
requireAll(require.context('../src/helpers/', true, /^((?!main).)*\.jsx?$/));
